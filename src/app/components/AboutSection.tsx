export function AboutSection() {
  return (
    <section id="nosotros" className="py-32 bg-black text-white overflow-hidden">
      <div className="max-w-[90rem] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="reveal space-y-10">
          <div className="inline-flex items-center gap-3 text-[#78B803] text-xs tracking-[0.3em] uppercase border border-[#78B803]/20 px-4 py-2 rounded-full">
            <span className="w-1.5 h-1.5 bg-[#78B803] rounded-full animate-pulse" />
            ¿Quiénes Somos?
          </div>

          <h2 className="text-5xl md:text-7xl font-black font-grandis-extended tracking-tighter uppercase leading-[0.88]">
            Fuente de <br />{" "}
          ...
          <div className="grid grid-cols-1 gap-6 pt-4">
            <div className="pl-6 border-l-2 border-[#78B803]">
              <h4 className="text-sm font-bold tracking-widest text-[#78B803] uppercase mb-2">Nuestra Misión</h4>
            ...
            <div className="pl-6 border-l-2 border-white/10">
              <h4 className="text-sm font-bold tracking-widest text-gray-400 uppercase mb-2">Nuestra Visión</h4>
        ...
        <div className="reveal relative h-[500px] md:h-[700px] rounded-3xl overflow-hidden">
          <img
          ...
          <div className="absolute bottom-8 left-8 right-8">
            <div className="bg-black/60 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              <p className="text-xl font-medium italic text-gray-200 leading-snug">
