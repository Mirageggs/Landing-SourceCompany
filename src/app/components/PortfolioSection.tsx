...
export function PortfolioSection() {
  return (
    <section id="portafolio" className="py-32 bg-black text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {projects.map((project) => (
            <div
              ...
              style={{ minHeight: project.tall ? "500px" : "280px", background: project.bg }}
            >
              <div className="absolute inset-0 flex items-center justify-center p-12">
                {project.img ? (
                  ...
                  <div className="text-6xl font-black text-[#78B803]/20 group-hover:text-[#78B803]/40 transition-colors duration-500 text-center">
                    {"</>"}
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <h3 className="text-2xl font-black tracking-tight uppercase">{project.title}</h3>
              </div>
